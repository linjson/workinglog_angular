...
public final class PersonList extends Table {
  ...
  public Person p(int j) { return p(new Person(), j); }
  public Person p(Person obj, int j) { int o = __offset(4); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int pLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }

  public static int createPersonList(FlatBufferBuilder builder,
      int pOffset) {
    builder.startObject(1);
    PersonList.addP(builder, pOffset);
  ...
  public static void addP(FlatBufferBuilder builder, int pOffset) { builder.addOffset(0, pOffset, 0); }
  public static int createPVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startPVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
